        ...
        <>
            <div className="flex flex-col h-full w-full justify-start">
                <div className="pt-10 h-5/6 overflow-y-scroll">
                    ...
                    <a href="/Certs/GeneralAssembly.pdf" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">General Assembly (SEI Course)</li>
                    </a>
                    <a href="/Certs/EPLAN.pdf" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">E-Plan Certificate</li>
                    </a>
                    <a href="/Certs/" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">UL</li>
                    </a>
                    <a href="/Certs/" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">Fanuc Level 1</li>
                    </a>
                    <a href="/Certs/" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">Fanuc Level 2</li>
                    </a>
                    <a href="/Certs/Bachelors.pdf" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">Bachelors Degree</li>
                    </a>
                    <a href="/Certs/Associates.pdf" target="_blank">                    
                        <li className="pl-10 pr-10 text-left">Associates Degree</li>
                    </a>
                    <a href="/Certs/HighSchool.pdf" target="_blank">                    
