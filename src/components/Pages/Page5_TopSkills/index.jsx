        ...
        <>
            <div className="flex flex-col h-full w-full justify-start">
                <div className="pt-10 h-5/6 overflow-y-scroll">
                    ...
                    <a href="/newPortfolio/Certs/GeneralAssembly.pdf" target="_blank" className="hover:text-blue-500">                    
                        <li className="pl-10 pr-10 text-left">General Assembly (SEI Course)</li>
                    </a>
                    <a href="/newPortfolio/Certs/EPLAN.pdf" target="_blank" className="hover:text-blue-500">                    
                        <li className="pl-10 pr-10 text-left">E-Plan Certificate</li>
                    </a>
                    <a href="/newPortfolio/Certs/" target="_blank">                    
                    ...
                    <a href="/newPortfolio/Certs/Bachelor.png" target="_blank" className="hover:text-blue-500">                    
                        <li className="pl-10 pr-10 text-left">Bachelors Degree</li>
                    </a>
                    <a href="/newPortfolio/Certs/Associates.png" target="_blank" className="hover:text-blue-500">                    
                        <li className="pl-10 pr-10 text-left">Associates Degree</li>
                    </a>
                    <a href="/newPortfolio/Certs/HighSchool.png" target="_blank" className="hover:text-blue-500">                    
